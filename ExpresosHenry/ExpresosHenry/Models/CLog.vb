Imports System.IO
''' <summary>
''' Clase encargada de Escribir el archivo de log 
''' http://jafs.es/1343/vb-net-crear-un-log-sencillo/
''' </summary>
Public Class CLog
  ...
  Private Shared Sub add(ByVal eTipo As TipoMensaje,
    ...
    If eTipo >= eNivel Then
      ...
      Dim objFichero As New IO.FileStream(sDestino, FileMode.Append,
                                         FileAccess.Write)
